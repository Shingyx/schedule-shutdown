    ...
    describe('scheduleShutdown', () => {
        it('correct command when input is 0', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 0', '-e', 'tell app "System Events" to shut down'],
                    false,
                ],
            ]);
        });
        ...
        it('correct command when input is 1', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 60', '-e', 'tell app "System Events" to shut down'],
                    false,
                ],
            ]);
        });
        ...
        it('correct command when input is 67', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 4020', '-e', 'tell app "System Events" to shut down'],
                    false,
                ],
            ]);
        });
    ...
    describe('scheduleRestart', () => {
        it('correct command when input is 0', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 0', '-e', 'tell app "System Events" to restart'],
                    false,
                ],
            ]);
        });
        ...
        it('correct command when input is 1', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 60', '-e', 'tell app "System Events" to restart'],
                    false,
                ],
            ]);
        });
        ...
        it('correct command when input is 67', async () => {
            ...
            assert.deepEqual(detachedSpawnHelperStub.args, [
                [
                    'osascript',
                    ['-e', 'delay 4020', '-e', 'tell app "System Events" to restart'],
                    false,
                ],
            ]);
        });
        ...
        it('correct command', async () => {
            ...
            assert.deepEqual(execHelperStub.args, [
                [
                    ...
                    [
                        '-f',
                        'osascript -e delay [0-9]+ -e tell app "System Events" to (shut down|restart)',
                    ],
                    false,
                ],
            ]);
